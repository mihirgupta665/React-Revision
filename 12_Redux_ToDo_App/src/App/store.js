...
reduces : are function to manipulate the states that take the current state and an action as arguments, and return a new state result . (like event handlers)
